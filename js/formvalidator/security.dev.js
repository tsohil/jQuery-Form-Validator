...
(function($) {
    ...
    $.formUtils.addValidator({
        ...
        validate : function(val, $el, conf, lang, $form) {
            if($el.attr('data-validation-backend-valid'))
                return true;
            else if($el.attr('data-validation-backend-invalid'))
                return false;
            ...
            if($el.attr('data-validation-backend-url')) {
                backendUrl = $el.attr('data-validation-backend-url');
            ...
            $.ajax({
                ...
                success : function(json) {
                    if(json.success) {
                        $el.attr('data-validation-backend-valid', 'true');
                    }
                    else {
                        $el.attr('data-validation-backend-invalid', 'true');
                        if(json.message)
                    ...
                    $el
                        .bind('keyup', function() {
                            $(this)
                                .removeAttr('data-validation-backend-valid')
                                .removeAttr('data-validation-backend-invalid')
